...
public final class ReflectionUtils {
	 ...
	 *             ClassNotFoundException If the desired target class with the specified name and package cannot be
	 *             found
	 ...
	 *             If the types of the arguments do not match the parameter types of the constructor (this should not
	 *             occur since it searches for a constructor with the types of the arguments)
	 ...
	 * @throws NoSuchMethodException
	 *             If the desired method of the desired target class with the specified name and parameter types cannot
	 *             be found
	 * @throws ClassNotFoundException
	 *             If the desired target class with the specified name and package cannot be found
	 * @see #getClass(String, PackageType)
	 ...
	 * @throws IllegalArgumentException
	 *             If the types of the arguments do not match the parameter types of the method (this should not occur
	 *             since it searches for a method with the types of the arguments)
	 * @throws InvocationTargetException
	 *             If the desired method cannot be invoked on the target object
	 * @throws NoSuchMethodException
	 *             If the desired method of the class of the target object with the specified name and arguments cannot
	 *             be found
	 * @see #getMethod(Class, String, Class...)
	 ...
	 *             If the desired method cannot be invoked on the target object
	 * @throws NoSuchMethodException
	 *             If the desired method of the desired target class with the specified name and arguments cannot be
	 *             found
	 * @throws ClassNotFoundException
	 *             If the desired target class with the specified name and package cannot be found
	 * @see #getClass(String, PackageType)
	 ...
	 * @return The value of field of the target object
	 * @throws IllegalArgumentException
	 *             If the target object does not feature the desired field (should not occur since it searches for a
